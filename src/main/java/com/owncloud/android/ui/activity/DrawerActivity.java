...
public abstract class DrawerActivity extends ToolbarActivity implements DisplayUtils.AvatarGenerationListener {
    ...
    protected void setupDrawerMenu(NavigationView navigationView) {
        ...
        if (getResources().getBoolean(R.bool.mindfabrik_hide_photo)) {
            navigationView.getMenu().removeItem(R.id.nav_photos);
        }
        if (getResources().getBoolean(R.bool.mindfabrik_hide_autosync)) {
            navigationView.getMenu().removeItem(R.id.nav_synced_folders);
        }
        if (getResources().getBoolean(R.bool.mindfabrik_hide_notification)) {
            navigationView.getMenu().removeItem(R.id.nav_notifications);
        }
        if (getResources().getBoolean(R.bool.mindfabrik_hide_ondevice)) {
            navigationView.getMenu().removeItem(R.id.nav_on_device);
        }
